...
namespace Hyun
{
    ...
    public class EventDispatcher
    {
        ...
        {
            Hyun.Debug.Log.MessageFormat("TriggerEvent --> {0}", eventType);
        ...
        {
            Hyun.Debug.Log.MessageFormat("TriggerEvent --> {0}({1})", eventType, arg1.ToString());
        ...
        {
            Hyun.Debug.Log.MessageFormat("TriggerEvent --> {0}({1},{2})", eventType, arg1.ToString(), arg2.ToString());
        ...
        {
            Hyun.Debug.Log.MessageFormat("TriggerEvent --> {0}({1},{2},{3})", eventType, arg1.ToString(), arg2.ToString(), arg3.ToString());
        ...
        {
            Hyun.Debug.Log.MessageFormat("TriggerEvent --> {0}({1},{2},{3},{4})", eventType, arg1.ToString(), arg2.ToString(), arg3.ToString(), arg4.ToString());
