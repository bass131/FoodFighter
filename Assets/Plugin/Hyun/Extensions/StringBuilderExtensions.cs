...
namespace Hyun.Extensions
{
    ...
    public static class StringBuilderExtensions
    {
        ...
        public static StringBuilder AppendFormatWithColor(this StringBuilder sb, Color clr, string format, params object[] args)
        {
            string tagClr = string.Format("<color=#{0}>", ColorUtility.ToHtmlStringRGBA(clr));
            sb.Append(tagClr);
